...
class SequenceGenerator(object):
    def __init__(
        ...
        """Generates candidate translations from a source sentence.
        """
        self.models = models
    ...
    def generate_batched_itr(
        ...
        for sample in data_itr:
            ...
            for i, id in enumerate(s['id'].data):
                ...
                # src = utils.strip_pad(input['ctx_tokens'].data[i, :], self.pad)
    ...
    def _generate(self, encoder_input, beam_size=None, maxlen=None, prefix_tokens=None):
        ...
        for model in self.models:
            ...
            #过滤掉模型不期望的值
            encoder_input_filtered = {k: v for k, v in encoder_input.items() if
                                      k in model.encoder.forward.__code__.co_varnames}
            encoder_input = encoder_input_filtered

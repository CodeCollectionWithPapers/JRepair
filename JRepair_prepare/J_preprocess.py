...
from Prepare_utils import indexed_dataset, dictionary
...
def get_parser():
    ...
    parser.add_argument("--srcdict", metavar="FP", help="reuse given src dictionary")
    parser.add_argument(
        "--nwordstgt",
        metavar="N",
        default=-1,
    ...
    parser.add_argument(
        "--joined-dictionary", action="store_true", help=""
    )
...
if __name__ == "__main__":
    parser = get_parser()
    parser.add_argument("--max-tokens", default=12000)
    parser.add_argument("--max-source-positions", default=2048)
    parser.add_argument("--max-target-positions", default=2048)
    parser.add_argument("--max-sent-len", default=2048)
    parser.add_argument("--truncate-sequence", default=True)
